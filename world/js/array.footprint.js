 ...
 * 活动范围框
 */
var LIMIT_W = 109.082946; // 经度
var LIMIT_E = 120.316838; // 经度
var LIMIT_S = 21.565269; // 纬度
var LIMIT_N = 34.802846; // 纬度
var arrayRectangleLimit = [
    [LIMIT_W, LIMIT_N], // 左上
    [LIMIT_E, LIMIT_N], // 右上
    [LIMIT_E, LIMIT_S], // 右下
    [LIMIT_W, LIMIT_S], // 左下
...
var arrayFootprint = [
    // 豫：河南省
    {"center": "113.585574,34.743753", "type": 1, "name": "阳光城丽景公馆（中原区）"},
    {"center": "113.592334,34.759204", "type": 1, "name": "五建新街坊（中原区）"},
    {"center": "113.594167,34.746224", "type": 1, "name": "保利心语（中原区）"},
    {"center": "113.599542,34.727754", "type": 1, "name": "盛世卧龙城（中原区）"},
    {"center": "113.601999,34.772283", "type": 1, "name": "九龙城（中原区）"},
    {"center": "113.621017,34.802846", "type": 1, "name": "谦祥福晟兴隆城（惠济区）"},
    {"center": "113.626560,34.671054", "type": 1, "name": "东原晴天见（二七区）"},
    {"center": "113.629973,34.696536", "type": 2, "name": "亚星云水居（二七区）"},
    {"center": "113.630550,34.676504", "type": 1, "name": "招商天地华府（二七区）"},
    {"center": "113.635175,34.781735", "type": 1, "name": "亚新美好城邦（金水区）"},
    {"center": "113.640196,34.682858", "type": 1, "name": "泰宏建业国际城（二七区）"},
    {"center": "113.658075,34.745793", "type": 1, "name": "郑州站"},
    {"center": "113.659697,34.697553", "type": 1, "name": "郑州客运南站"},
    {"center": "113.684351,34.683322", "type": 1, "name": "绿都澜湾（管城区）"},
    {"center": "113.686464,34.697352", "type": 1, "name": "绿都紫荆华庭（管城区）"},
    {"center": "113.695758,34.644163", "type": 1, "name": "正商智慧城（新郑市）"},
    {"center": "113.696815,34.689741", "type": 1, "name": "永威城（管城区）"},
    {"center": "113.697761,34.694453", "type": 1, "name": "正商中州城（管城区）"},
    {"center": "113.726497,34.686469", "type": 1, "name": "中岳俪景湾（管城区）"},
    {"center": "113.757933,34.691714", "type": 1, "name": "金沙湖高尔夫观邸（经开区）"},
    {"center": "113.758495,34.764319", "type": 1, "name": "省教育厅行政服务大厅(出版大厦)"},
    {"center": "113.778555,34.759095", "type": 1, "name": "郑州东站"},
    {"center": "113.788690,34.693248", "type": 1, "name": "拓丰·祥和居（经开区）"},
    {"center": "113.854823,34.526056", "type": 1, "name": "新郑国际机场"},
    {"center": "113.860586,34.685960", "type": 1, "name": "九龙新城（经开区）"},
    {"center": "113.903949,34.775550", "type": 1, "name": "融创美盛象湖壹号（郑东新区）"},
    ...
    {"center": "114.040484,33.629372", "type": 1, "name": "关徐村"},
    {"center": "114.043729,33.570250", "type": 2, "name": "漯河站"},
    ...
    {"center": "114.575250,34.524619", "type": 1, "name": "东羊羔桥村"},
    ...
    {"center": "113.410987,22.508091", "type": 1, "name": "紫马岭公园"},
    ...
    {"center": "113.853963,22.579046", "type": 1, "name": "西乡体育中心"},
    ...
    {"center": "113.907306,22.527573", "type": 1, "name": "深圳西站"},
    ...
    {"center": "114.029113,22.609725", "type": 1, "name": "深圳北站"},
    ...
    {"center": "114.085409,22.537082", "type": 1, "name": "深圳市中医院"},
    ...
    {"center": "119.280968,26.096915", "type": 1, "name": "福州格林豪泰快捷酒店"},

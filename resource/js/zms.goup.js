$(document).ready(function () {
    $.goup({
        ...
        trigger: 400, // 100
        bottomOffset: 10, // 150
        locationOffset: 25, // 100
        containerRadius: 28, //
        alwaysVisible: false,
        entryAnimation: "fade", // fade,slide
        goupSpeed: "quick", // quick,slow
        hideUnderWidth: 800, // 500
        containerColor: "#1e87e4", // #d1d6d9
        containerClass: "goup-container", // "goup-container"
        arrowColor: "#ffffff", // #1e2a31 #2288ff
...
(function (e) {
    ...
    e.goup = function (n) {
        ...
        v = {
            ...
            background: p,
            cursor: "pointer",
            "box-shadow": "0 0 4px rgba(0, 0, 0, 0.14), 0 4px 8px rgba(0, 0, 0, 0.28)" // AZ:Add shadow
        };
        v["bottom"] = a;
        v[o] = u;
        v["border-radius"] = f;

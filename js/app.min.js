"use strict";
/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && $("html").addClass(
    ...
    if ($("html").hasClass("ismobile") || $(".c-overflow")[0] && a(".c-overflow", "minimal-dark", "y"), $(
        ".navigation__sub")[0] && $("body").on("click", ".navigation__sub > a", function (a) {
        a.preventDefault(), $(this).closest(".navigation__sub").toggleClass("navigation__sub--toggled"), $(this).parent()
            .find("ul").stop().slideToggle(250)
        ...
        $.simpleWeather({
            ...
            success: function (a) {
                var c =
                    '<div class="widget-weather__current clearfix"><div class="widget-weather__icon widget-weather__icon-' +
                    a.code + '"></div><div class="widget-weather__info"><h2>' + a.temp + "°" + a.units.temp +
                    '</h2><div class="widget-weather__region"><span>' + a.city + ", " + a.region + "</span><span>" + a.currently +
                    '</span></div></div></div><ul class="widget-weather__upcoming clearfix"></ul>';
                $("#widget-weather__main").html(c), setTimeout(function () {
                    for (b = 0; b < 5; b++) {
                        var c =
                            '<li class="media"><span class="pull-left widget-weather__icon widget-weather__icon-sm widget-weather__icon-' +
                            a.forecast[b].code + '"></span><span class="pull-right">' + a.forecast[b].high + "/" + a.forecast[
                            b].low + '</span><span class="media-body">' + a.forecast[b].text + "</span></li>";
    ...
    if ($(".form-group--float")[0] && ($(".form-group--float").each(function () {
        ...
        $("body").on("click", ".action-header__toggle", function (a) {
            a.preventDefault(), c = $(this).closest(".action-header").find(".action-header__search"), c.fadeIn(300), c.find(
                ".action-header__input").focus()
    ...
    $("input-mask")[0] && $(".input-mask").mask(), $(".color-picker")[0] && $(".color-picker").each(function () {
        ...
        enableTouch: !0
    }), $('[data-toggle="tooltip"]')[0] && $('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]')[0] && $(
        '[data-toggle="popover"]').popover(), $("html").hasClass("ie9") && $("input, textarea").placeholder({
    ...
    c.on("click", "[data-mae-action]", function (d) {
        ...
        switch (e) {
        case "block-open":
            b = $(this).data("mae-target"), $(b).addClass("toggled"), c.addClass("block-opened"), c.append(
                '<div data-mae-action="block-close" data-mae-target="' + b +
                '" class="mae-backdrop mae-backdrop--sidebar" />');
            break;
        case "block-close":

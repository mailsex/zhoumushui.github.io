...
!function (a, b, c) {
    ...
    function j() {
        this.element.trigger("initialize" + H), m.call(this), this.selection = this.options.selection && null != this.identifier,
            o.call(this), q.call(this), C.call(this), A.call(this), r.call(this), n.call(this), this.element.trigger(
            "initialized" + H)
    }
    ...
    function m() {
        ...
        c.children().each(function () {
            ...
            b.columns.push(f), null != f.order && (b.sortDictionary[f.id] = f.order), f.identifier && (b.identifier = f
                .id, b.converter = f.converter), b.options.multiSort || null === f.order || (d = !0)
        })
    }
    ...
    function n() {
        ...
        function d(a, b) {
            e.currentRows = a, p.call(e, b), e.options.keepSelection || (e.selectedRows = []), y.call(e, a), t.call(e),
                v.call(e), e.element._bgBusyAria(!1).trigger("loaded" + H)
        }
        ...
        if (this.element._bgBusyAria(!0).trigger("load" + H), F.call(this), this.options.ajax) {
            var f = g.call(this),
                h = i.call(this);
            if (null == h || "string" != typeof h || 0 === h.length) throw new Error(
            ...
            var j = {
                ...
                data: f,
                success: function (b) {
                    e.xqr = null, "string" == typeof b && (b = a.parseJSON(b)), b = e.options.responseHandler(b), e.current =
                        b.current, d(b.rows, b.total)
                },
    ...
    function q() {
        ...
        this.element.addClass(this.options.css.table), 0 === this.element.children("tbody").length && this.element.append(
            b.body), 1 & this.options.navigation && (this.header = a(b.header.resolve(f.call(this, {
                    ...
                    var o = a(e.actionDropDownCheckboxItem.resolve(f.call(c, {
                        ...
                        if (!e.prop("disabled")) {
                            ...
                            d.parents(m).find(j + ":has(" + k + ":checked)")._bgEnableAria(f).find(k)._bgEnableField(f),
                                c.element.find("tbody").empty(), C.call(c), n.call(c)
                        }
                    });
        ...
        if (0 !== this.options.navigation) {
            ...
            if (-1 !== this.rowCount && c.length > 0) {
                var d = this.options.templates,
                    ...
                    o = i >= n ? n : i;
                w.call(this, j, "first", "«", "first")._bgEnableAria(g > 1), w.call(this, j, "prev", "<",
                    "prev")._bgEnableAria(g > 1);
                for (var p = 0; o > p; p++) {
                    var q = p + m;
                    w.call(this, j, q, q, "page-" + q)._bgEnableAria()._bgSelectAria(q === g)
                }
                0 === o && w.call(this, j, 1, 1, "page-1")._bgEnableAria(!1)._bgSelectAria(), w.call(this, j, "next",
                    ">", "next")._bgEnableAria(i > g), w.call(this, j, "last", "»", "last")._bgEnableAria(i >
                    g), E.call(this, c, j)
            }
        }
    }
        ...
        if (0 !== this.options.navigation) {
            ...
            if (g.length > 0) {
                ...
                o.on("keyup" + H, function (c) {
                    c.stopPropagation();
                    var d = a(this).val();
                    (l !== d || 13 === c.which && "" !== d) && (l = d, (13 === c.which || 0 === d.length || d.length >=
                    i.options.searchSettings.characters) && (b.clearTimeout(k), k = b.setTimeout(function () {
                        B.call(i, d)
    ...
    function D(a) {
        var b = this.options.css,
            ...
            f = a.find(c);
        if (this.options.multiSort || (a.parents("tr").first().find(c).removeClass(b.iconDown + " " + b.iconUp), this.sortDictionary = {}),
            e && "asc" === e) this.sortDictionary[d] = "desc", f.removeClass(b.iconUp).addClass(b.iconDown);
    ...
    var H = ".rs.jquery.bootgrid",
        I = function (b, c) {
            this.element = a(b), this.origin = this.element.clone(), this.options = a.extend(!0, {}, I.defaults, this.element
                .data(), c);
            var d = this.options.rowCount = this.element.data().rowCount || c.rowCount || this.options.rowCount;
            this.columns = [], this.current = 1, this.currentRows = [], this.identifier = null, this.selection = !1,
                this.converter = null, this.rowCount = a.isArray(d) ? d[0] : d, this.rows = [], this.searchPhrase = "",
                this.selectedRows = [], this.sortDictionary = {}, this.total = 0, this.totalPages = 0, this.cachedParams = {
    ...
    if (I.defaults = {
            ...
            padding: 2,
            columnSelection: !0,
            rowCount: [10, 25, 50, -1], // AZ:ROW COUNT [10, 25, 50, -1]
            selection: !1,
            multiSelect: !1,
            rowSelect: !1,
            keepSelection: !1,
            ...
            return a(b).off(H), 1 & this.options.navigation && this.header.remove(), 2 & this.options.navigation && this.footer
                .remove(), this.element.before(this.origin).remove(), this
            ...
            if (this.selection) {
                ...
                for (var c, d, e = []; b.length > 0 && (this.options.multiSelect || 1 !== e.length);) if (c = b.pop(), -1 ===
                    a.inArray(c, this.selectedRows)) for (d = 0; d < this.currentRows.length; d++) if (this.currentRows[
                        d][this.identifier] === c) {
                ...
                if (e.length > 0) {
                    ...
                    for (d = 0; !this.options.keepSelection && g && d < this.currentRows.length;) g = -1 !== a.inArray(this
                            .currentRows[d++][this.identifier], this.selectedRows);
                    for (this.element.find("thead " + f).prop("checked", g), this.options.multiSelect || this.element.find(
                        "tbody > tr " + f + ":checked").trigger("click" + H), d = 0; d < this.selectedRows.length; d++) this
                        .element.find('tbody > tr[data-row-id="' + this.selectedRows[d] + '"]').addClass(this.options.css
                            .selected)._bgAria("selected", "true").find(f).prop("checked", !0);
            ...
            if (this.selection) {
                b = b || this.currentRows.propValues(this.identifier);
                for (var c, d, e, f = []; b.length > 0;) if (c = b.pop(), e = a.inArray(c, this.selectedRows), -1 !== e) for (
                    d = 0; d < this.currentRows.length; d++) if (this.currentRows[d][this.identifier] === c) {
                        f.push(this.currentRows[d]), this.selectedRows.splice(e, 1);
                        break
                    }
                if (f.length > 0) {
                    var g = h(this.options.css.selectBox);
                    for (this.element.find("thead " + g).prop("checked", !1), d = 0; d < f.length; d++) this.element.find(
                        'tbody > tr[data-row-id="' + f[d][this.identifier] + '"]').removeClass(this.options.css.selected)
                        ._bgAria("selected", "false").find(g).prop("checked", !1);
            ...
            var c = b ? a.extend({}, b) : {};
            return c === this.sortDictionary ? this : (this.sortDictionary = c, C.call(this), G.call(this), n.call(this),
                this)
            ...
            _bgEnableAria: function (a) {
                return null == a || a ? this.removeClass("disabled")._bgAria("disabled", "false") : this.addClass(
                    "disabled")._bgAria("disabled", "true")
            },
            ...
            _bgSelectAria: function (a) {
                return null == a || a ? this.addClass("active")._bgAria("selected", "true") : this.removeClass("active")._bgAria(
                    "selected", "false")
            },
            _bgId: function (a) {
